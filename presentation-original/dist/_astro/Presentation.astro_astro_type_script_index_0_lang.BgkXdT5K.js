import{X}from"./reveal.esm.fDNnGve_.js";function Y(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let E={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const j=/[&<>"']/,G=new RegExp(j.source,"g"),Q=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,tt=new RegExp(Q.source,"g"),et={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},D=h=>et[h];function x(h,n){if(n){if(j.test(h))return h.replace(G,D)}else if(Q.test(h))return h.replace(tt,D);return h}const nt=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function W(h){return h.replace(nt,((n,t)=>(t=t.toLowerCase())==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const st=/(^|[^\[])\^/g;function k(h,n){h=typeof h=="string"?h:h.source,n=n||"";const t={replace:(e,s)=>(s=(s=s.source||s).replace(st,"$1"),h=h.replace(e,s),t),getRegex:()=>new RegExp(h,n)};return t}const it=/[^\w:]/g,rt=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function U(h,n,t){if(h){let e;try{e=decodeURIComponent(W(t)).replace(it,"").toLowerCase()}catch{return null}if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}n&&!rt.test(t)&&(t=(function(e,s){R[" "+e]||(at.test(e)?R[" "+e]=e+"/":R[" "+e]=M(e,"/",!0)),e=R[" "+e];const a=e.indexOf(":")===-1;return s.substring(0,2)==="//"?a?s:e.replace(ot,"$1")+s:s.charAt(0)==="/"?a?s:e.replace(lt,"$1")+s:e+s})(n,t));try{t=encodeURI(t).replace(/%25/g,"%")}catch{return null}return t}const R={},at=/^[^:]+:\/*[^/]*$/,ot=/^([^:]+:)[\s\S]*$/,lt=/^([^:]+:\/*[^/]*)[\s\S]*$/,C={exec:function(){}};function Z(h,n){const t=h.replace(/\|/g,((s,a,r)=>{let i=!1,o=a;for(;--o>=0&&r[o]==="\\";)i=!i;return i?"|":" |"})).split(/ \|/);let e=0;if(t[0].trim()||t.shift(),t.length>0&&!t[t.length-1].trim()&&t.pop(),t.length>n)t.splice(n);else for(;t.length<n;)t.push("");for(;e<t.length;e++)t[e]=t[e].trim().replace(/\\\|/g,"|");return t}function M(h,n,t){const e=h.length;if(e===0)return"";let s=0;for(;s<e;){const a=h.charAt(e-s-1);if(a!==n||t){if(a===n||!t)break;s++}else s++}return h.slice(0,e-s)}function H(h,n){if(n<1)return"";let t="";for(;n>1;)1&n&&(t+=h),n>>=1,h+=h;return t+h}function B(h,n,t,e){const s=n.href,a=n.title?x(n.title):null,r=h[1].replace(/\\([\[\]])/g,"$1");if(h[0].charAt(0)!=="!"){e.state.inLink=!0;const i={type:"link",raw:t,href:s,title:a,text:r,tokens:e.inlineTokens(r)};return e.state.inLink=!1,i}return{type:"image",raw:t,href:s,title:a,text:x(r)}}class q{constructor(n){this.options=n||E}space(n){const t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){const t=this.rules.block.code.exec(n);if(t){const e=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:M(e,`
...
`,n=n.substring(l.length+1),S=!0),!S){const v=new RegExp(`^ {0,${Math.min(3,r-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),_=new RegExp(`^ {0,${Math.min(3,r-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),b=new RegExp(`^ {0,${Math.min(3,r-1)}}(?:\`\`\`|~~~)`),I=new RegExp(`^ {0,${Math.min(3,r-1)}}#`);for(;n&&(u=n.split(`
`,1)[0],l=u,this.options.pedantic&&(l=l.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),!b.test(l))&&!I.test(l)&&!v.test(l)&&!_.test(n);){if(l.search(/[^ ]/)>=r||!l.trim())w+=`
`+l.slice(r);else{if(o||d.search(/[^ ]/)>=4||b.test(d)||I.test(d)||_.test(d))break;w+=`
`+l}o||l.trim()||(o=!0),e+=u+`
`,n=n.substring(u.length+1),d=l.slice(r)}}f.loose||(c?f.loose=!0:/\n *\n *$/.test(e)&&(c=!0)),this.options.gfm&&(s=/^\[[ xX]\] /.exec(w),s&&(a=s[0]!=="[ ] ",w=w.replace(/^\[[ xX]\] +/,""))),f.items.push({type:"list_item",raw:e,task:!!s,checked:a,loose:!1,text:w}),f.raw+=e}f.items[f.items.length-1].raw=e.trimRight(),f.items[f.items.length-1].text=w.trimRight(),f.raw=f.raw.trimRight();const L=f.items.length;for(i=0;i<L;i++)if(this.lexer.state.top=!1,f.items[i].tokens=this.lexer.blockTokens(f.items[i].text,[]),!f.loose){const v=f.items[i].tokens.filter((b=>b.type==="space")),_=v.length>0&&v.some((b=>/\n.*\n/.test(b.raw)));f.loose=_}if(f.loose)for(i=0;i<L;i++)f.items[i].loose=!0;return f}}html(n){const t=this.rules.block.html.exec(n);if(t){const e={type:"html",raw:t[0],pre:!this.options.sanitizer&&(t[1]==="pre"||t[1]==="script"||t[1]==="style"),text:t[0]};if(this.options.sanitize){const s=this.options.sanitizer?this.options.sanitizer(t[0]):x(t[0]);e.type="paragraph",e.text=s,e.tokens=this.lexer.inline(s)}return e}}def(n){const t=this.rules.block.def.exec(n);if(t){const e=t[1].toLowerCase().replace(/\s+/g," "),s=t[2]?t[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline._escapes,"$1"):"",a=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline._escapes,"$1"):t[3];return{type:"def",tag:e,raw:t[0],href:s,title:a}}}table(n){const t=this.rules.block.table.exec(n);if(t){const e={type:"table",header:Z(t[1]).map((s=>({text:s}))),align:t[2].replace(/^ *|\| *$/g,"").split(/ *\| */),rows:t[3]&&t[3].trim()?t[3].replace(/\n[ \t]*$/,"").split(`
